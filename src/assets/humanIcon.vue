<template>
   <svg width="64px" height="64px" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g id="SVGRepo_iconCarrier">
         ...
         <path d="M219.968 106.121C241.931 80.0587 278.638 143.309 281.516 119.913" :stroke="color" stroke-opacity="0.9"
            stroke-width="16" stroke-linecap="round" stroke-linejoin="round"></path>
         <path d="M157.258 63.7549C121.516 74.7106 105.852 117.17 121.513 148.401" :stroke="color" stroke-opacity="0.9"
            stroke-width="16" stroke-linecap="round" stroke-linejoin="round"></path>
         <path d="M110.544 171.591C97.2219 190.533 110.121 194.598 125.903 188.961" :stroke="color" stroke-opacity="0.9"
            stroke-width="16" stroke-linecap="round" stroke-linejoin="round"></path>
         <path d="M125.988 193.171C121.915 260.485 266.13 345.452 275.71 186.666" :stroke="color" stroke-opacity="0.9"
            stroke-width="16" stroke-linecap="round" stroke-linejoin="round"></path>
         <path
